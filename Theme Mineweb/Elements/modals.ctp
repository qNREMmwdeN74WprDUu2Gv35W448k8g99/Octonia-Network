<div class="modal modal-medium fade" id="login" tabindex="-1" role="dialog" aria-labelledby="loginLabel" aria-hidden="true">
    <div class="modal-dialog">
        <div class="modal-content"
             style="background-color: black; margin-left: auto; margin-right: auto; width: 500px;">
            <div class="modal-header">
                <h4 class="modal-title" id="myModalLabel"><?= $Lang->get('USER__LOGIN') ?></h4>
            </div>
            <div class="modal-body">
                <form class="form-horizontal" method="POST" data-ajax="true" action="<?= $this->Html->url(array('plugin' => null, 'admin' => false, 'controller' => 'user', 'action' => 'ajax_login')) ?>"
                      data-redirect-url="?">
                    <div class="form-group">
                        <label for="inputEmail3" class="col-sm-12 control-label"><?= $Lang->get('USER__USERNAME') ?>
                            :</label>
                        <div class="col-sm-12">
                    ...
                    <div class="form-group">
                        <label class="col-sm-12 control-label"><?= $Lang->get('USER__PASSWORD') ?> :</label>
                        <div class="col-sm-12">
            ...
            <div class="modal-footer">
                <div class="col-md-12">
                    <button type="button" data-dismiss="modal" href="#" data-toggle="modal" data-target="#lostpasswd" class="nk-btn nk-btn-block nk-btn-lg link-effect-4 ready"><?= $Lang->get('USER__PASSWORD_FORGOT_LABEL') ?></button>
                    <button type="submit" class="nk-btn nk-btn-block nk-btn-lg nk-btn-color-main-1 link-effect-4 ready"><?= $Lang->get('USER__LOGIN') ?></button>
                </div>
            </div>
            </form>
        </div>
        ...
        <div class="modal-content"
            ...
            <div class="modal-body">
                <form class="form-horizontal" method="POST" data-ajax="true"
                      action="<?= $this->Html->url(array('plugin' => null, 'admin' => false, 'controller' => 'user', 'action' => 'ajax_lostpasswd')) ?>"
                      data-redirect-url="?">
            ...
            <div class="modal-footer">
                <div class="col-md-12">
                <button type="button" data-dismiss="modal" data-toggle="modal" class="nk-btn nk-btn-block nk-btn-lg link-effect-4 ready"><?= $Lang->get('GLOBAL__CLOSE') ?></button>
                <button type="submit" class="nk-btn nk-btn-block nk-btn-lg nk-btn-color-main-1 link-effect-4 ready"><?= $Lang->get('USER__PASSWORD_FORGOT_SEND_MAIL') ?></button>
                </div>
            </div>
            </form>
        </div>
    ...
    <div class="modal-dialog">
        ...
        <div class="modal-body">
          <form class="form-horizontal" method="POST" data-ajax="true" action="<?= $this->Html->url(array('plugin' => null, 'admin' => false, 'controller' => 'user', 'action' => 'ajax_resetpasswd')) ?>" data-redirect-url="?">
            ...
            <div class="form-group">
              <label  class="col-sm-12 control-label"><?= $Lang->get('USER__PASSWORD_CONFIRM') ?> :</label>
              <div class="col-sm-12">
        ...
        <div class="modal-footer">
            <div class="col-md-12">
              <button type="button" class="nk-btn nk-btn-block nk-btn-lg link-effect-4 ready" data-dismiss="modal"><?= $Lang->get('GLOBAL__CLOSE') ?></button>
              <button type="submit" class="nk-btn nk-btn-block nk-btn-lg nk-btn-color-main-1 link-effect-4 ready"><?= $Lang->get('GLOBAL__SAVE') ?></button>
            </div>
        </div>
        </form>
        </div>
  ...
  <div class="modal-dialog">
      ...
      <div class="modal-body">
        <form class="form-horizontal" method="POST" data-ajax="true" action="<?= $this->Html->url(array('plugin' => null, 'admin' => false, 'controller' => 'user', 'action' => 'ajax_register')) ?>" data-redirect-url="?">
          <div class="form-group">
            <label  class="col-sm-12 control-label"><?= $Lang->get('USER__USERNAME') ?> :</label>
            <div class="col-sm-12">
          ...
          <div class="form-group">
            <label  class="col-sm-12 control-label"><?= $Lang->get('USER__EMAIL') ?> :</label>
            <div class="col-sm-12">
          ...
          <?php if($reCaptcha['type'] == "google") { ?>
            ...
            <div class="form-group">
              <label class="col-sm-12 control-label"><?= $Lang->get('FORM__CAPTCHA') ?> :</label>
              <div class="col-sm-12">
          ...
          <?php } else { ?>
            <div class="form-group">
              <label for="inputPassword3" class="col-sm-12 control-label"><?= $Lang->get('FORM__CAPTCHA') ?> :</label>
              <div class="col-sm-12">
                <?php
      ...
      <div class="modal-footer">
          <div class="col-md-12">
        <button type="button" class="nk-btn nk-btn-block nk-btn-lg link-effect-4 ready" data-dismiss="modal"><?= $Lang->get('GLOBAL__CLOSE') ?></button>
        <button type="submit" class="nk-btn nk-btn-block nk-btn-lg nk-btn-color-main-1 link-effect-4 ready"><?= $Lang->get('USER__REGISTER') ?></button>
          </div>
      </div>
        </form>
      </div>
    ...
    <div class="modal modal-medium fade" id="notifications_modal" tabindex="-1" role="dialog">
        <div class="modal-dialog">
            <div class="modal-content" style="background-color: black; margin-left: auto; margin-right: auto; width: 500px;">
                ...
                <div class="modal-footer">
                    <div class="col-md-12">
                        <button type="button" class="nk-btn nk-btn-block nk-btn-lg nk-btn-block link-effect-4 ready" onclick="notification.markAllAsSeen()" data-dismiss="modal">Marquer toutes mes notifications</button>
                        <button type="submit" class="nk-btn nk-btn-block nk-btn-lg nk-btn-block nk-btn-color-main-1 link-effect-4 ready" onclick="notification.clearAll()" data-dismiss="modal"><?= $Lang->get('NOTIFICATIONS__CLEAR_ALL') ?></button>
                    </div>
                </div>
            </div>
        </div>
