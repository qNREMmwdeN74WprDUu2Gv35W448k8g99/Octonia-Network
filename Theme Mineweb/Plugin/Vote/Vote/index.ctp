    ...
    <div class="row">
        <div class="col-md-12">
            <div class="row step active" id="step-1">
                <div class="col-md-12">
                    <div class="col-md-12 thumbnail setup-content text-center">
                        <br>
                        ...
                        <form data-ajax="true" action="<?= $this->Html->url(['action' => 'setUser']) ?>" method="post" data-callback-function="afterSetUser">
                            <div style="width: 350px;display: inline-block;">
                                ...
                                <input type="text" class="form-control" name="username" placeholder="Votre pseudo" <?= ($user) ? 'value="' . $user['pseudo'] . '" disabled' : '' ?>>
                            </div>
                            <br><br>
                            <button class="nk-btn nk-btn-block nk-btn-lg nk-btn-block link-effect-4 ready btn-block" type="submit">Passer a l'étape suivante</button>
                        </form>
            ...
            <div class="row step" id="step-2">
                <div class="col-md-12">
                    <div class="col-md-12 thumbnail setup-content">
                        <div class="loader">
                            <p>
                                    ...
                                    echo '<div class="panel panel-default">';
                                        ...
                                        echo '<div class="panel-body">';
                                            foreach ($websites as $website) {
                                                echo '<a data-website-id="' . $website['Website']['id'] . '" href="' . $website['Website']['url'] . '" target="_blank" class="nk-btn nk-btn-block nk-btn-lg nk-btn-block link-effect-4 ready btn-block website">' . $website['Website']['name'] . '</a>';
                                            }
                                        echo '</div>';
                                    echo '</div>';
                                echo '</div>';
                    ...
                    <div class="col-md-12 thumbnail setup-content">
                        ...
                        <div class="row">
                            <div class="col-md-12 col-md-offset-12">
                                ...
                                <button class="nk-btn nk-btn-block nk-btn-lg nk-btn-block link-effect-4 ready btn-block get-reward" data-reward="now"><?= $Lang->get('VOTE__GET_REWARD_NOW') ?></button>
                                <button class="nk-btn nk-btn-block nk-btn-lg nk-btn-block link-effect-4 ready btn-block get-reward" data-reward="later"><?= $Lang->get('VOTE__GET_REWARD_LATER') ?></button>
                            </div>
                        </div>
    ...
    <div class="modal-dialog modal-lg">
        <div class="modal-content" style="background-color: black; margin-left: auto; margin-right: auto; width: 500px;">
            ...
            <div class="modal-body text-center">
                ...
                <a href="#" id="voteBtn" target="_blank" onclick="$('#redirectModal').modal('hide');startTimerCheckVote()" class="nk-btn nk-btn-block nk-btn-lg nk-btn-block link-effect-4 ready btn-block"><?= $Lang->get('VOTE__MODAL_BTN') ?></a>
            </div>
        </div>
    </div>
</div>